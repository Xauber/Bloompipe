...
dir = str(os.getcwd())
sys.path.insert(0, dir + "/Synthesis/stylegan2")
import dnnlib
...
def convert_tf_generator(tf_G):
    ...
    # Convert params.
    from stylegan2.training import networks
...
def convert_tf_discriminator(tf_D):
    ...
    _populate_module_params(D,
                            ...
                            r'b(\d+)\.conv(\d+)\.weight',
                            lambda r, i: tf_params[f'{r}x{r}/Conv{i}{["", "_down"][int(i)]}/weight'].transpose(3, 2, 0,
                                                                                                               1),
                            r'b(\d+)\.conv(\d+)\.bias',
...
@click.option('--force-fp16', help='Force the networks to use FP16', type=bool, default=False, metavar='BOOL',
              show_default=True)
